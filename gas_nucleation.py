...
ax.set_title('Gas Nucleation (Density), Time = 0')
fig.colorbar(c)
...
def animate(i):
    ...
    ax.set_title(f'Gas Nucleation (Density), Time = {i*dt:.2f}')
    return c,
...
# Save the animation
ani.save(f'gas_nuc_den_{tf}.gif', writer='imagemagick')
...
ax.set_title('Gas Nucleation (Magnetization), Time = 0')
fig.colorbar(c)
...
def animate(i):
    ...
    ax.set_title(f'Gas Nucleation (Magnetization), Time = {i*dt:.2f}')
    return c,
...
# Save the animation
ani.save(f'gas_nuc_mag_{tf}.gif', writer='imagemagick')
