...
ax.set_title('Liquid Nucleation (Density), Time = 0')
fig.colorbar(c)
...
def animate(i):
    ...
    ax.set_title(f'Liquid Nucleation (Density), Time = {i*dt:.2f}')
    return c,
...
# Save the animation
ani.save(f'liq_nuc_den_{tf}.gif', writer='imagemagick')
...
ax.set_title('Liquid Nucleation (Magnetization), Time = 0')
fig.colorbar(c)
...
def animate(i):
    ...
    ax.set_title(f'Liquid Nucleation (Magnetization), Time = {i*dt:.2f}')
    return c,
...
# Save the animation
ani.save(f'liq_nuc_mag_{tf}.gif', writer='imagemagick')
